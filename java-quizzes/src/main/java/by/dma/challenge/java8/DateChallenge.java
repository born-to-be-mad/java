...
/**
 * How ot work with Date and Time in Java.
 *
...
public class DateChallenge {
    public static void main(String... doYourBest) {
        List<SpiderMan> spiderManList =
                Arrays.asList(new SpiderMan("The Spider Man", LocalDate.of(1962, Month.SEPTEMBER, 8)),
        ...
        spiderManList.forEach(s -> {
            ...
            System.out.println(
                    s.costume + " " + period.get(ChronoUnit.YEARS) + " years " + period.get(ChronoUnit.DAYS) + " days");
        });
    }
    ...
    static class SpiderMan {
        ...
        SpiderMan(String costume, LocalDate dateOfBirth) {
            ...
            this.creationDate = dateOfBirth.plusDays(2)
                                           .plusYears(2); // Line 32
        }
    }
}
