...
/**
 * Demo for {@code CountDownLatch}.
 * See {@linkplain https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/CountDownLatch.html}.
 *
...
public class Race {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        START.countDown();//Команда дана, уменьшаем счетчик на 1
        //счетчик становится равным нулю, и все ожидающие потоки одновременно разблокируются => ГОНКА начнется
    }
